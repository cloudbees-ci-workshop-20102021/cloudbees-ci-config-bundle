...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/cloudbees-ci-workshop-20102021/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>cloudbees-ci-workshop-20102021</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>cloudbees-ci-workshop-20102021</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/cloudbees-ci-workshop-20102021/pipeline-template-catalog.git</repositoryUrl>
              <traits>
